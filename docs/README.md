...
- [AWS Lambda (Node)](aws-lambda.md)
- [AWS Lambda (Python)](aws-lambda-python.md)
- [Node Express](node-express.md)
- [Node Koa](node-koa.md)
- [Next.js](nextjs.md)
- [NestJS](nestjs.md)
- [Hono](hono.md)
- [Cloudflare Workers](cloudflare-workers.md)
- [Vercel Edge](vercel-edge.md)
- [Fastly Compute](fastly-compute.md)
- [Client JS](client-js.md)
- [FastAPI](fastapi.md)
- [Django](django.md)
- [Laravel](laravel.md)
- [Rails](rails.md)
- [Spring Boot](spring-boot.md)
- [Go net/http](go-nethttp.md)
- [Go middleware (legacy)](go-middleware.md)
- [Nginx auth_request](nginx-auth-request.md)
