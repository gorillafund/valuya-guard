...
export type ValuyaExpressOptions = {
  resource?: string
  plan?: string
  base?: string
  tenantToken?: string
  subject?: (req: ExpressLikeReq) => Subject
  successUrl?: string
  cancelUrl?: string
}

export function valuyaExpress(opts: ValuyaExpressOptions = {}) {
...
function defaultSubject(req: ExpressLikeReq): Subject {
...
function normalizeHeaders(h: ExpressLikeReq["headers"]): Record<string, string> {
