...
export class GuardTelegramLinkService {
  ...
  async ensureLinkedForPaymentAction(args: {
    ...
    | { allowed: true; subject: AgentSubject; link: StoredTelegramChannelLink }
...
function toSubject(link: StoredTelegramChannelLink): AgentSubject {
